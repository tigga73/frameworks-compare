...
(async () => {
  ...
  const measureLoadRows = async () => {
    await page.goto("http://localhost:4200/loadRows");
  ...
  const measureUpdateRows = async () => {
    await page.goto("http://localhost:4200/updateRows");
    await page.waitForSelector("button");
    const start = performance.now();
    await page.click("button");
    await page.waitForFunction(
  ...
  const measureSelectRow = async () => {
    await page.goto("http://localhost:4200/selectRow");
    ...
    await page.waitForFunction(
      () => document.querySelector("h4").innerText === "Linha Selecionada:",
    );
  ...
  const measureEditRow = async () => {
    await page.goto("http://localhost:4200/editRow");
    await page.waitForSelector("button");
    const start = performance.now();
    await page.click("button");
    await page.waitForSelector("h4");
  ...
  const measureCreateRows = async () => {
    await page.goto("http://localhost:4200/createRows");
    await page.waitForSelector("button");
    const start = performance.now();
    await page.click("button");
    await page.waitForFunction(
  ...
  const measureDeleteRows = async () => {
    await page.goto("http://localhost:4200/deleteRows");
    await page.waitForSelector("button");
    const start = performance.now();
    await page.click("button");
    await page.waitForFunction(
